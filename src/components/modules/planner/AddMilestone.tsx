...
import { useAddMilestone } from "@/queries/planner.queries";
...
const AddMilestone = ({ id }: { id: string }) => {
    ...
    const onSubmit = async (data: z.infer<typeof milestoneSchema>) => {
        console.log(data);
        addMilestone.mutate({ data, plannerId: id, reset: form.reset, setOpen })
    }
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <div>
                <DialogTrigger asChild>
                    <Button className="cursor-pointer" variant="default"><Plus /> Add Milestone</Button>
                </DialogTrigger>
